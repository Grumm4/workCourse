...
{
    public partial class tovInStock : Form
    {
        public int offset = 0;
        ...
        private void tovInStock_Load(object sender, EventArgs e)
        {
        ...
        void addToOrder()
        {
            ...
            {
                decimal price = Convert.ToDecimal(dataGridView1[4, dataGridView1.SelectedRows[0].Index].Value);
                priceLabel += Convert.ToInt32(Math.Round(price, 0));
                label3.Text = $"{priceLabel * numericUpDown1.Value}";
        ...
        private void dataGridView1_CellMouseClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            ...
            decimal price = Convert.ToDecimal(dataGridView1[4, dataGridView1.SelectedRows[0].Index].Value);
            int priceLabel = Convert.ToInt32(Math.Round(price, 0));
            label4.Text = $"{priceLabel * numericUpDown1.Value}";
        ...
        private void numericUpDown1_ValueChanged(object sender, EventArgs e)
        {
            ...
            decimal price = Convert.ToDecimal(dataGridView1[4, dataGridView1.SelectedRows[0].Index].Value);
            int priceLabel = Convert.ToInt32(Math.Round(price, 0));
            label4.Text = $"Текущая цена: {priceLabel * numericUpDown1.Value}";
        }
    }
}
